...
namespace Common
{
    ...
    public class HcFaceDetection : IHcFaceDetection, IDisposable
    {
        ...
        public HcFaceDetection(HcFaceDetectionSettings settings)
        {
        ...
        public void Dispose()
        {
            _frontClassifier.Dispose();
            _profileClassifier.Dispose();
        }
    }
}